...
constants <- list(
  ...
  breaks=breaks, 
  cutoff=cutoff, 
  nobs_imbcr=nobs_imbcr, 
  sites_imbcr=sites_imbcr, 
  years_imbcr=years_imbcr, 
  # bbs
  nobs_bbs=nobs_bbs, 
  sites_bbs=sites_bbs, 
  years_bbs=years_bbs, 
  nroute_bbs=nroute_bbs, 
  route_bbs=route_bbs, 
  nobser_bbs=nobser_bbs, 
  obser_bbs=obser_bbs, 
  new_bbs=new_bbs, 
  nstop_bbs=nstop_bbs, 
  stops_bbs=stops_bbs, 
  # ebd
  nobs_ebird=nobs_ebird, 
  sites_ebird=sites_ebird, 
  years_ebird=years_ebird, 
  nlocat_ebird=nlocat_ebird, 
  locat_ebird=locat_ebird, 
  nobser_ebird=nobser_ebird, 
  obser_ebird=obser_ebird, 
  type_ebird=type_ebird, 
  duration_ebird=duration_ebird, 
  distance_ebird=distance_ebird, 
  n_obsver_ebird=n_obsver_ebird, 
  gra=gra, tem=tem
)
...
inits <- list(
  zeta=0.2, 
  beta_lambda0=c(2,0.5,-1,-1), 
  beta_rho=c(0.1,0,-0.1,-0.1), 
  sigma=60, 
  theta=0.4, 
  chi_mu=-6, 
  chi_route_sd=1, 
